...
DDate:         2014-9-26 17:01:19
VVersion:      1.88 build 5
=================================================================================*/
...
/*
#define  Crossbar_1		0x90		//0x90 0x10 ! (Crossbar_1) Mixer values for X11, X21, X31, X41
#define  Crossbar_1		0x91		//0x91 0x10 ! (Crossbar_1) Mixer values for X12, X22, X32, X42
#define  Crossbar_1		0x92		//0x92 0x10 ! (Crossbar_1) Mixer values for X13, X23, X33, X43
#define  Crossbar_1		0x93		//0x93 0x10 ! (Crossbar_1) Mixer values for X14, X24, X34, X44
#define  Crossbar_1		0x94		//0x94 0x10 ! (Crossbar_1) Mixer values for X51, X52, X53, X54
#define  Crossbar_1		0x95		//0x95 0x10 ! (Crossbar_1) Mixer values for X55, X15, X25, X35
#define  Crossbar_1		0x96		//0x96 0x10 ! (Crossbar_1) Mixer values for X45, X61, X62, X63
#define  Crossbar_1		0x97		//0x97 0x10 ! (Crossbar_1) Mixer values for X64, X65, X66, X16
#define  Crossbar_1		0x98		//0x98 0x10 ! (Crossbar_1) Mixer values for X26, X36, X46, X56
#define  Crossbar_1		0x99		//0x99 0x10 ! (Crossbar_1) Mixer values for X71, X72, X73, X74
#define  Crossbar_1		0x9A		//0x9A 0x10 ! (Crossbar_1) Mixer values for X75, X76, X17, X27
#define  Crossbar_1		0x9B		//0x9B 0x10 ! (Crossbar_1) Mixer values for X37, X47, X57, X67
#define  Crossbar_1		0x9C		//0x9C 0x10 ! (Crossbar_1) Mixer values for X77, X81, X82, X83
#define  Crossbar_1		0x9D		//0x9D 0x10 ! (Crossbar_1) Mixer values for X84, X85, X86, X87
#define  Crossbar_1		0x9E		//0x9E 0x10 ! (Crossbar_1) Mixer values for X18, X28, X38, X48
#define  Crossbar_1		0x9F		//0x9F 0x10 ! (Crossbar_1) Mixer values for X58, X68, X78, X88*/
...
#define  BP2_Ins1		0xA2		//0xA2 0x14 ! (BP2) BiQuad Coefficients for Instance 1
#define  BP2_Ins2		0xA3		//0xA3 0x14 ! (BP2) BiQuad Coefficients for Instance 2
#define  BP3_Ins1		0xA4		//0xA4 0x14 ! (BP3) BiQuad Coefficients for Instance 1
#define  BP3_Ins2		0xA5		//0xA5 0x14 ! (BP3) BiQuad Coefficients for Instance 2
#define  BP4_Ins1		0xA6		//0xA6 0x14 ! (BP4) BiQuad Coefficients for Instance 1
#define  BP4_Ins2		0xA7		//0xA7 0x14 ! (BP4) BiQuad Coefficients for Instance 2
#define  BP5_Ins1		0xA8		//0xA8 0x14 ! (BP5) BiQuad Coefficients for Instance 1
#define  BP5_Ins2		0xA9		//0xA9 0x14 ! (BP5) BiQuad Coefficients for Instance 2
#define  BP5_Ins3		0xAA		//0xAA 0x14 ! (BP5) BiQuad Coefficients for Instance 3
#define  BP5_Ins4		0xAB		//0xAB 0x14 ! (BP5) BiQuad Coefficients for Instance 4
#define  BP6_Ins1		0xAC		//0xAC 0x14 ! (BP6) BiQuad Coefficients for Instance 1
#define  BP6_Ins2		0xAD		//0xAD 0x14 ! (BP6) BiQuad Coefficients for Instance 2
#define  Mix4Ch_1		0xAE		//0xAE 0x10 ! (Mix4Ch_1) Gain function for Channel 1-4
#define  Mix4Ch_2		0xAF		//0xAF 0x10 ! (Mix4Ch_2) Gain function for Channel 1-4
#define  AGC_H1_ae		0xB0		//0xB0 0x8 ! (AGC_H1) ae and 1_ae/*
#define  AGC_H1		0xB1		//0xB1 0x10 ! (AGC_H1) T1_input and T2_input
#define  AGC_H1		0xB2		//0xB2 0xC ! (AGC_H1) k0, k1, and k2
#define  AGC_H1		0xB3		//0xB3 0x10 ! (AGC_H1) O1_input and O2_input
#define  AGC_H1		0xB4		//0xB4 0x10 ! (AGC_H1) aa, 1_aa, ad, and 1_ad*/
#define  AGC_H1_enable		0xB5		//0xB5 0x8 ! (AGC_H1) DRC enable
#define  AGC_B1_ae		0xB6		//0xB6 0x8 ! (AGC_B1) ae and 1_ae/*
#define  AGC_B1		0xB7		//0xB7 0x10 ! (AGC_B1) T1_input and T2_input
#define  AGC_B1		0xB8		//0xB8 0xC ! (AGC_B1) k0, k1, and k2
#define  AGC_B1		0xB9		//0xB9 0x10 ! (AGC_B1) O1_input and O2_input
#define  AGC_B1		0xBA		//0xBA 0x10 ! (AGC_B1) aa, 1_aa, ad, and 1_ad
#define  AGC_B1		0xBB		//0xBB 0x8 ! (AGC_B1) DRC enable*/
#define  AGC_L1_ae		0xBC		//0xBC 0x8 ! (AGC_L1) ae and 1_ae/*
#define  AGC_L1		0xBD		//0xBD 0x10 ! (AGC_L1) T1_input and T2_input
#define  AGC_L1		0xBE		//0xBE 0xC ! (AGC_L1) k0, k1, and k2
#define  AGC_L1		0xBF		//0xBF 0x10 ! (AGC_L1) O1_input and O2_input
#define  AGC_L1		0xC0		//0xC0 0x10 ! (AGC_L1) aa, 1_aa, ad, and 1_ad
#define  AGC_L1		0xC1		//0xC1 0x8 ! (AGC_L1) DRC enable*/
#define  AGC_H2_ae		0xC2		//0xC2 0x8 ! (AGC_H2) ae and 1_ae/*
#define  AGC_H2		0xC3		//0xC3 0x10 ! (AGC_H2) T1_input and T2_input
#define  AGC_H2		0xC4		//0xC4 0xC ! (AGC_H2) k0, k1, and k2
#define  AGC_H2		0xC5		//0xC5 0x10 ! (AGC_H2) O1_input and O2_input
#define  AGC_H2		0xC6		//0xC6 0x10 ! (AGC_H2) aa, 1_aa, ad, and 1_ad
#define  AGC_H2		0xC7		//0xC7 0x8 ! (AGC_H2) DRC enable*/
...
/*
#define  TAS3204AudioApp_1		0xC8		//0xC8 0x4 ! (TAS3204AudioApp_1) Delay Pointer 0 and 1 Length
#define  TAS3204AudioApp_1		0xC9		//0xC9 0x4 ! (TAS3204AudioApp_1) Delay Pointer 2 and 3 Length
#define  TAS3204AudioApp_1		0xCA		//0xCA 0x4 ! (TAS3204AudioApp_1) Delay Pointer 4 and 5 Length
...
#define  AGC_B2_ae		0xD5		//0xD5 0x8 ! (AGC_B2) ae and 1_ae/*
#define  AGC_B2		0xD6		//0xD6 0x10 ! (AGC_B2) T1_input and T2_input
#define  AGC_B2		0xD7		//0xD7 0xC ! (AGC_B2) k0, k1, and k2
#define  AGC_B2		0xD8		//0xD8 0x10 ! (AGC_B2) O1_input and O2_input
#define  AGC_B2		0xD9		//0xD9 0x10 ! (AGC_B2) aa, 1_aa, ad, and 1_ad
#define  AGC_B2		0xDA		//0xDA 0x8 ! (AGC_B2) DRC enable*/
#define  Mix4Ch_7		0xDB		//0xDB 0x10 ! (Mix4Ch_7) Gain function for Channel 1-4
#define  Mix4Ch_9		0xDC		//0xDC 0x10 ! (Mix4Ch_9) Gain function for Channel 1-4
#define  Limiter6_ae		0xDD		//0xDD 0x8 ! (Limiter6) ae and 1_ae/*
#define  Limiter6		0xDE		//0xDE 0x10 ! (Limiter6) T1_input and T2_input
#define  Limiter6		0xDF		//0xDF 0xC ! (Limiter6) k0, k1, and k2
#define  Limiter6		0xE0		//0xE0 0x10 ! (Limiter6) O1_input and O2_input
#define  Limiter6		0xE1		//0xE1 0x10 ! (Limiter6) aa, 1_aa, ad, and 1_ad
#define  Limiter6		0xE2		//0xE2 0x8 ! (Limiter6) DRC enable*/
#define  AGC_L2_ae		0xE3		//0xE3 0x8 ! (AGC_L2) ae and 1_ae/*
#define  AGC_L2		0xE4		//0xE4 0x10 ! (AGC_L2) T1_input and T2_input
#define  AGC_L2		0xE5		//0xE5 0xC ! (AGC_L2) k0, k1, and k2
#define  AGC_L2		0xE6		//0xE6 0x10 ! (AGC_L2) O1_input and O2_input
#define  AGC_L2		0xE7		//0xE7 0x10 ! (AGC_L2) aa, 1_aa, ad, and 1_ad
#define  AGC_L2		0xE8		//0xE8 0x8 ! (AGC_L2) DRC enable*/
#define  VUMeter_1		0xE9		//0xE9 0x8 ! (VUMeter_1) RMS coefficient aSA and 1-aSA
#define  VUMeter_1_OutEn		0xEA		//0xEA 0x8 ! (VUMeter_1) OutputEnable
#define  Mix4Ch_10		0xEB		//0xEB 0x10 ! (Mix4Ch_10) Gain function for Channel 1-4
#define  Mix4Ch_11		0xEC		//0xEC 0x10 ! (Mix4Ch_11) Gain function for Channel 1-4/*
0xED 0x4 
0xEE 0x4 
0xEF 0x4 
0xF0 0x4 
